...
public class UserInformation implements ICommand
{
	...
	UserInformation()
	{
		...
		usersInformation.put(IDAndEntities.AMX,
			...
			中央山脈底下都埋藏著他的黃金和白銀，因此又稱為中央金庫。
			曾是大愛電視台和TVBS新聞台的主播，但是由於財力雄厚，經常透過新聞物色自己下一間要收購的企業。
			在龍王說有一位加油站的工讀生很可愛後，就開始考慮收購中油，並改名為虎油。
			...
			愛好是每天晚上都和地下室的50蘿莉以及25正太夜夜笙歌，經常因此而上班遲到，
		...
		usersInformation.put(IDAndEntities.FRISK,
			...
			經常灌輸他人自己程式很爛的印象，但大家都知道這並不是事實，反而正好相反。
		...
		usersInformation.put(IDAndEntities.ZEKK,
			...
			曾經和Frisk關係匪淺，問過對方可不可以同床摸摸，最後以Frisk曖昧不明的回答結束，目前不確定是暈船還是穩交。
			為了除他自己外沒人知道存不存在/有沒有可能有結果的男(女)朋友，而跟巧虎一樣對Frisk始亂終棄，並且不排除吃回頭草的可能。
			""");
	}
